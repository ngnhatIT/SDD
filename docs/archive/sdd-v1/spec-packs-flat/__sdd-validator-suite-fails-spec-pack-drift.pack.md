...
- Source manifest: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/spec-pack.manifest.yaml`
- Source package: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/`
...
- Source: `README.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/01-requirements.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/02-design.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/03-data-model.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/04-api-contract.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/05-behavior.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/06-edge-cases.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/07-tasks.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/08-acceptance-criteria.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/09-test-cases.md`
...
- README scope and out-of-scope notes: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/README.md`
- One backend export endpoint
- One audit data model
- One generated spec-pack
- Additional screens
- Shared module refactors
- Design non-changes: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/02-design.md`
- No shared frontend changes
- No asynchronous job flow

## Traceability Snapshot

- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/README.md`
...
- Shared refactors
- UI redesign
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/01-requirements.md`
...
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/03-data-model.md`
...
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/04-api-contract.md`
...
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/07-tasks.md`

## Acceptance Notes

- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/08-acceptance-criteria.md`

## Test Notes

- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/09-test-cases.md`

## Locked Contracts

- `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/contracts/openapi.yaml`
- `docs/specs-support/fixtures/__sdd-validator-suite-fails-spec-pack-drift/contracts/schemas/fixture-export-request.schema.json`
