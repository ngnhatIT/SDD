...
6. `docs/spec-packs/<feature-id>/reinforcement.md` for non-trivial work
7. relevant files in `docs/standards/`
8. the task-specific trace artifact under `docs/spec-packs/<feature-id>/`, such as `verification.md`, `review.md`, or `audit.md`
9. `docs/decisions/`
10. `docs/archive/sdd-v1/` only when active docs still leave a legacy implementation gap
...
8. only the relevant files in `docs/standards/`
9. the task-specific trace artifact under `docs/spec-packs/<feature-id>/`, such as `verification.md`, `review.md`, or `audit.md`, when resuming, reviewing, or closing work
