...
- Source manifest: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/spec-pack.manifest.yaml`
- Source package: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/`
...
- Source: `README.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/01-requirements.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/02-design.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/03-data-model.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/04-api-contract.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/05-behavior.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/06-edge-cases.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/07-tasks.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/08-acceptance-criteria.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/09-test-cases.md`
...
- README scope and out-of-scope notes: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/README.md`
- One backend export endpoint
- One audit data model
- One generated spec-pack
- Additional screens
- Shared module refactors
- Design non-changes: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/02-design.md`
- No shared frontend changes
- No asynchronous job flow

## Traceability Snapshot

- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/README.md`
...
- Shared refactors
- UI redesign
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/01-requirements.md`
...
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/03-data-model.md`
...
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/04-api-contract.md`
...
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/07-tasks.md`

## Acceptance Notes

- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/08-acceptance-criteria.md`

## Test Notes

- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/09-test-cases.md`

## Locked Contracts

- `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/contracts/openapi.yaml`
- `docs/specs-support/fixtures/__sdd-validator-suite-passes-full-path-valid/contracts/schemas/fixture-export-request.schema.json`
