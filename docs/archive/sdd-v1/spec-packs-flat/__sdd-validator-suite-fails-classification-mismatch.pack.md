...
- Source manifest: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/spec-pack.manifest.yaml`
- Source package: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/`
...
- Source: `README.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/01-requirements.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/02-design.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/03-data-model.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/04-api-contract.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/05-behavior.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/06-edge-cases.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/07-tasks.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/08-acceptance-criteria.md`
- Source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/09-test-cases.md`
...
- README scope and out-of-scope notes: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/README.md`
- One backend export endpoint
- One audit data model
- One generated spec-pack
- Additional screens
- Shared module refactors
- Design non-changes: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/02-design.md`
- No shared frontend changes
- No asynchronous job flow

## Traceability Snapshot

- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/README.md`
...
- Shared refactors
- UI redesign
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/01-requirements.md`
...
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/03-data-model.md`
...
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/04-api-contract.md`
...
- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/07-tasks.md`

## Acceptance Notes

- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/08-acceptance-criteria.md`

## Test Notes

- Table content kept in source: `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/09-test-cases.md`

## Locked Contracts

- `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/contracts/openapi.yaml`
- `docs/specs-support/fixtures/__sdd-validator-suite-fails-classification-mismatch/contracts/schemas/fixture-export-request.schema.json`
